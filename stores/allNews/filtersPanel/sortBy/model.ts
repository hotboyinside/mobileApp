...
import { $market } from '../filters/market';
import { filtersApplyClick } from '../filters/model';
import { $newsType } from '../filters/newsType';
import { $stockType } from '../filters/stockType/model';
import {
	FilterTabVariant,
...
export const discardSortByDraft = createEvent();
...
sample({
	clock: [applySortingClick, filtersApplyClick, initializeFiltersFx.done],
	source: {
		sortBy: $sortBy,
		market: $market,
		stockType: $stockType,
