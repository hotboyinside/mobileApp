...
export const Input = ({ type = "text", ...props }: CustomInputProps) => {
      ...
      <TouchableOpacity onPress={() => setIsPasswordVisible(prev => !prev)}>
        {isPasswordVisible && (
          <EyeOpenedIcon
            width={20}
            height={20}
            fill={props.errorMessage ? iconErrorColor : iconColor}
            color={props.errorMessage ? iconErrorColor : iconColor}
          />
        )}
        {!isPasswordVisible && (
          <EyeClosedIcon
  ...
  return (
    <RNInput
      ...
      inputContainerStyle={[
        ...
        props.errorMessage && { borderColor: inputBorderErrorColor },
