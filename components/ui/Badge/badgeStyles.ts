...
export const useBadgeStyles = (): {
	...
	const pillColorRedBgColor = useThemeColor(appTokens.background.errorPrimary);

	const pillColorGreenTextColor = useThemeColor(appTokens.text.successPrimary);
	const pillColorGreenBgColor = useThemeColor(
		appTokens.background.successPrimary
	);

	const filledPrimaryTextColor = useThemeColor(appTokens.text.primaryOnBrand);
	...
	const filledRedFgColor = useThemeColor(appTokens.foreground.errorSecondary);
	...
	const keywordsOrangeTextColor = useThemeColor(appTokens.utilityOrange[700]);
	const keywordsOrangeBgColor = useThemeColor(appTokens.utilityOrange[50]);

	const keywordsYellowTextColor = useThemeColor(appTokens.utilityYellow[700]);
	...
	const keywordsGrayBlueBgColor = useThemeColor(appTokens.utilityGrayBlue[50]);

	const keywordsVioletTextColor = useThemeColor(appTokens.utilityViolet[700]);
